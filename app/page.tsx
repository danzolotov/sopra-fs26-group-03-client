"use client";
import { LoginOutlined, UserAddOutlined, CheckCircleFilled } from "@ant-design/icons";
...
export default function Home() {
	...
	return (
		<div className="min-h-screen flex flex-col items-center justify-center p-6 bg-white">
			...
			<div className="mt-20 text-slate-400 text-sm">© 2026 PlateMate. All rights reserved.</div>
		</div>
	);
}
