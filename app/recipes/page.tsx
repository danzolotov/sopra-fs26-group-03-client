                        ...
                        <List.Item>
                            ...
                            >
                                ...
                                <div className="mt-auto">
                                    <Text strong className="block mb-2 text-slate-700">Ingredients:</Text>
                                    <div className="flex flex-wrap gap-2">
                                        {recipe.ingredients.map((ing) => (
                                            <Tag key={ing.id} color="blue" className="rounded-full px-3 border-none bg-blue-50 text-blue-600">
